...
#
#		C (cost function)-> trades off hyperplane surface simplicity + training examples missclassifications
#					Low value: simple/smooth hyperplane surface
#

classifier = svm.SVC(C=10)  # support vector classifier
classifier.fit(X, y)  # Training on training data set
